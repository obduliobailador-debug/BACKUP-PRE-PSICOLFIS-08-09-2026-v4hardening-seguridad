...
/**
 * #faq — accordion of frequent questions. Owns its own `expanded` state
 * so callers don't have to lift it. `openBudgetForm` is passed down for
 * the "Contactar ahora" CTA at the bottom.
 */
export const FaqSection = ({ openBudgetForm }) => {
